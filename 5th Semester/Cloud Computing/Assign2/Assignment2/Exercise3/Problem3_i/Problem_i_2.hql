CREATE VIEW result_hasgivenname AS SELECT * FROM yago_part_buck WHERE predicate == '<hasGivenName>';
CREATE VIEW result_livesin AS SELECT * FROM yago_part_buck WHERE predicate == '<livesIn>';
