CREATE VIEW result_hasgivenname AS SELECT * FROM yago_partition WHERE predicate == '<hasGivenName>';
CREATE VIEW result_livesin AS SELECT * FROM yago_partition WHERE predicate == '<livesIn>';
